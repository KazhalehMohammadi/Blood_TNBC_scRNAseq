...
library(MLmetrics)
# ===============================================================
file_path <- "F:\\TOP-BIOMARKERS\\Blood_Pac\\Top80_Biomarkers_WeightedScore.csv"
data <- read.csv(file_path, header = TRUE)
d <- data$gene
data_dir <- "D:/Thesis/Proposal/Thesis_Data/GSE169246/files"
names <- c("Pre_P008_b","Pre_P011_b",
...
saveRDS(filtered_counts, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\filtered_counts_matrix.rds")
filtered_counts <- readRDS("F:\\ML\\ML_Blood_Pacli\\GXBoots\\filtered_counts_matrix.rds")
...
for (sample in unique_samples) {
  repeat {
    ...
    label <- trimws(tolower(label))  # Trim spaces and lowercase
...
saveRDS(cell_labels,
        "F:\\ML\\ML_Blood_Pacli\\GXBoots\\cell_labels.rds")
cell_labels <- readRDS("F:\\ML\\ML_Blood_Pacli\\GXBoots\\cell_labels.rds")
write.csv(cell_labels, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\cell_labels.csv", row.names = FALSE)
fwrite(cell_labels,
       file = "F:\\ML\\ML_Blood_Pacli\\GXBoots\\cell_labels_fast.csv",
       row.names = FALSE)
# ====================================== GXBoots
filtered_counts <- readRDS("F:\\ML\\ML_Blood_Pacli\\GXBoots\\filtered_counts_matrix.rds")
cell_labels <- readRDS("F:\\ML\\ML_Blood_Pacli\\GXBoots\\cell_labels.rds")
...
saveRDS(xgb_model, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\xgboost_cv200f.rds")
write.csv(xgb_model$results, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\xgboost_cv200f.csv", row.names = FALSE)
...
# =========================== Extract the Precision، F1-Score، Accuracy و Recall from diffusion matrix 
...
sink("F:\\ML\\ML_Blood_Pacli\\GXBoots\\xgboost_best_model_summary.txt")
...
write.csv(top_features, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\xgboost_feature_importance100.csv")
png("F:\\ML\\ML_Blood_Pacli\\GXBoots\\xgboost_feature_importance_plot100.png", width = 800, height = 600)
...
save_gene_subset(top20, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_top20-200f.csv")
save_gene_subset(top50, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_top50-200f.csv")
save_gene_subset(top60, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_top60-200f.csv")
save_gene_subset(top70, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_top70-200f.csv")
save_gene_subset(top80, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_top80-200f.csv")
d_mapped <- make.names(d)
initial100 <- model_data[, c(intersect(d_mapped, colnames(model_data)), "Label")]
write.csv(initial100, "F:\\ML\\ML_Blood_Pacli\\GXBoots\\data_initial_100.csv", row.names = FALSE)
